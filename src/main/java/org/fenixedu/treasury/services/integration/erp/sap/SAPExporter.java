    ...
    public void requestPendingDocumentStatus(final FinantialInstitution institution) {
        ...
        for (DocumentStatusWS documentStatus : integrationStatusFor) {
            if (documentStatus.isIntegratedWithSuccess()) {
                String message = BundleUtil.getString(Constants.BUNDLE, "info.ERPExporter.sucess.integrating.document",
...
//                "no.documents.response"));
    ...
    private boolean sendDocumentsInformationToIntegration(FinantialInstitution institution, ERPExportOperation operation)
...
//                }
                ...
                if (integratedWithSuccess) {
                    ...
                    if (document != null) {
                        ...
                        operation.appendInfoLog(Constants.bundle("info.ERPExporter.error.integrating.document",
                                status.getDocumentNumber(), errorDescription));
    ...
    private void writeError(ERPExportOperation operation, Throwable t) {
    ...
    public ERPExportOperation exportFinantialDocumentToIntegration(final FinantialInstitution institution,
        ...
        try {
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.starting.finantialdocuments.integration"));
            ...
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.erp.xml.content.generated"));
            ...
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.finished.finantialdocuments.integration"));
    ...
    public ERPExportOperation exportCustomersToIntegration(FinantialInstitution institution) {
        ...
        ERPExportOperation operation = createSaftExportOperation(null, institution, new DateTime());
        try {
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.starting.customers.integration"));
            ...
            boolean success = sendDocumentsInformationToIntegration(institution, operation);
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.finished.customers.integration"));
    ...
    public ERPExportOperation exportProductsToIntegration(FinantialInstitution institution) {
        ...
        try {
            UnaryOperator<AuditFile> preProcessFunctionBeforeSerialize = getAuditFilePreProcessOperator(institution);
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.starting.products.integration"));
            ...
            boolean success = sendDocumentsInformationToIntegration(institution, operation);
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.finished.products.integration"));
    ...
    public ERPExportOperation retryExportToIntegration(final ERPExportOperation eRPExportOperation) {
        if (eRPExportOperation.getFinantialDocumentsSet().isEmpty()) {
            ...
            try {
                operation.appendInfoLog(Constants.bundle("label.ERPExporter.starting.retry.integration"));
            ...
            operation.appendInfoLog(Constants.bundle("label.ERPExporter.finished.retry.integration"));
            return operation;
