...
public class PaymentCodeGeneratorInstance extends PaymentCodeGeneratorInstance_Base {
    ...
    public PaymentCodeGeneratorInstance(final String implementationClassName) {
        this();
    ...
    public static PaymentCodeGeneratorInstance create(final String implementationClassName) {
        return new PaymentCodeGeneratorInstance(implementationClassName);
    }
