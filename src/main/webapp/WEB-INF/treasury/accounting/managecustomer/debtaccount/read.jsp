...
<c:if test="${filterAnnuled}">
	<p>
		<a class="btn btn-default btn-xs"
		    href="${pageContext.request.contextPath}<%= DebtAccountController.READ_URL %>${debtAccount.externalId}/false">
			<spring:message code="label.DebtAccountController.show.annuled" />
		</a>
	</p>
</c:if>
